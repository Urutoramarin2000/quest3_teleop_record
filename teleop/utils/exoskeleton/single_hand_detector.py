    ...
    def draw_skeleton_on_image(
        ...
        if style == "default":
            mp.solutions.drawing_utils.draw_landmarks(
                ...
                mp.solutions.drawing_styles.get_default_haagentnd_landmarks_style(),
...
def hand_pos(ret: bool, frame, detector):
    ...
    if ret:
        ...
        if joint_pos is None:
            # print(f"{detector.detected_hand_type}: NO HAND DETECTED")
            return None

        SingleHandDetector.draw_skeleton_on_image(frame, keypoint_2d)
        return joint_pos
